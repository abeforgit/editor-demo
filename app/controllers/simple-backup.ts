...
import { ember_chart, emberChartView } from 'editor-demo/nodes/chart-backup';
...
export default class SimpleController extends Controller {
        ...
        new InputRule(
          ...
          (
            ...
            tr.replaceRangeWith(
              ...
              state.schema.node('ember_chart', {
                chartId: match.groups?.['id'],
              })
            );
            return tr;
          }
  ...
  @tracked nodeViews = (controller: SayController) => {
    return { ember_chart: emberChartView(controller) };
  };
